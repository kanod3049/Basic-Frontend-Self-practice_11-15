...
// Show Confirmation 
// ================================
export function showConfirmModal(texts, onConfirmCallback, confirmText = "Confirm", cancelText = "Cancel") {
    ...
    if(confirmCancelBtn) {
        ...
        confirmCancelBtn.textContent = confirmText;
    ...
    if(keepBtn) {
        ...
        keepBtn.textContent = cancelText; 
    }
}